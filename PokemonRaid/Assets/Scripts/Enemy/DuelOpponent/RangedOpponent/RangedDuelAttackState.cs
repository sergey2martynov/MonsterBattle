...
{
    public class RangedDuelAttackState : EnemyAttackState<RangedDuelOpponentView>
    {
        ...
        public RangedDuelAttackState(RangedDuelOpponentView view, BaseEnemyLogic<RangedDuelOpponentView> logic,
        ...
        protected override void SetNextState()
        {
            ...
            _logic.SwitchState<EnemyIdleState<RangedDuelOpponentView>>();
        }
